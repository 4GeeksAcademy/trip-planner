        ...
        <div className="container-fluid mx-auto p-2">
            <div className="d-flex justify-content-center mt-4 rounded">
                <div className="rounded rounded-3 border shadow-sm" style={{ width: "80%" }}>
                    <img src="https://images.unsplash.com/photo-1606574977100-456d9a074578?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8TW9udW1lbnRvcyUyMGN1bHR1cmFsZXN8ZW58MHx8MHx8fDA%3D" style={{ width: "100%", height: "600px", objectFit: "cover" }} alt="Paisaje" />
                    <div className="p-3 bg-opacity-10 bg-dark">
                        <h3>Ciudad, País</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="d-flex justify-content-center mt-5">
                <div className="d-flex m-3" style={{ width: "80%" }}>
                    <div className="me-3 border-black border-end border-3 ">
                    ...
                    <div className="card bg-light " style={{ width: "60rem", height: "7rem" }}>
                        ...
                        <div className="card-body text-center p-2">
                            <h2 className="card-text">1000 $</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className=" p-2">
                                {infoComentarios.map(comentario => (
                                    <div className="media mb-4" key={comentario.id}>
                                        <div className=" rounded rounded-3 border shadow-sm bg-opacity-10 bg-dark m-2 p-2">
                                            <h6 className="mt-0">{comentario.usuario}</h6>
                                            {comentario.mensaje}
                                        </div>
                                    </div>
                                ))}
